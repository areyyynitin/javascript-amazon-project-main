...
// const del =deliveryDate.format('dddd, MMMM D')
// console.log(del)

let cartSummaryHTML ='';
// loop through this 'cart' array to generate HTML
...
const dateString = deliveryDate.format('dddd, MMMM D');
    ...
    <div class="cart-item-details-grid">
        ...
        <div class="product-quantity">
            ...
            <span class="delete-quantity-link link-primary jsDeleteLink" data-product-id="${matchingProduct.id}">
            Delete
            </span>
        </div>
        </div>
...
function deliveryOptionsHTML(matchingProduct,cartItem){
    ...
    deliveryOptions.forEach((deliveryOption) => {
        const today = dayjs();
            ...
            html += `
            <div class="delivery-option jsDeliveryOption"
...
document.querySelectorAll('.jsDeleteLink').forEach( (link) => {
